...
# print("what does luffies future look like? what does luffies adventure look like currently what is luffy and his crew doing whats there next location whats there main goal")


print("should luffy move left,right,backwards or forwards/should luffy jump away back off or keep going")
print("left,right,backwards,forwards")
luffy_move = input("which way should luffy move \n")
print("luffy moved  " + luffy_move)
print("jump away, back off, keep going")
luffy_action = input("what action should luffy do \n")
print("luffy action" + luffy_action)
print("Gomu Gomu no Pistol,Gomu Gomu no Rocket,Gomu Gomu no Bazooka,Gomu Gomu no Gatling")
luffy_attack = input("what attack should luffy do \n")
print("luffy attack" + luffy_attack)
